...
const SignIn: React.FC = () => {
  const [credentialsObj, setCredentialsObj] = useState({ email: "", password: "" });
  ...
  async function handleMainUserLogin() {
    try {
      await signIn("google", {
        redirect: true,
        callbackUrl: "/",
  ...
  async function handleSubUserLogin(e: React.FormEvent) {
    e.preventDefault();
    try {
      ...
      console.error("Error during sub-user login:", error);
    }
  }
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 items-center justify-center flex gap-4" href="/">
                <Image
                ...
                <div className="font-medium">
                  <p className="text-4xl">Tube Gate</p>
                </div>
              </Link>
          ...
          {/* Second Section: Tab Structure for Login */}
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              {/* Sub User Login */}
              {activeTab === "sub" && (
                <form onSubmit={handleSubUserLogin}>
                <div className="mb-4">
